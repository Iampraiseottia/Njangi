            ...
            <form className='flex flex-col gap-1 w-full max-w-xl'>
              <div className='flex flex-col gap-3'>
                <div className='flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full'> 
                  <label htmlFor="birth_certificate" className='font-semibold text-lg tracking-wide mb-1 sm:mb-0'>
              ...
              <div className='flex flex-col gap-3'> 
                ...
                <div className='flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full'> 
                  <label htmlFor="identification_card" className='font-semibold text-lg tracking-wide mb-1 sm:mb-0'>
                    🚼 Upload Your Birth Certificate:
                  </label>
                  <div className='flex items-center w-full sm:w-auto'>
                    <input 
                ...
                <div 
                  className='w-full text-base bg-transparent h-60 rounded-xl border-2 border-[#0ef] py-3 px-4 focus:ring-1 focus:ring-[#0ef] focus:outline-none duration-300'
                ></div>
              </div> <br />
              ...
              <div className='flex flex-col gap-3'>
                ...
                <div className='flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full'> 
                  <label htmlFor="uploaded_pic" className='font-semibold text-lg tracking-wide mb-1 sm:mb-0'>
                    🚼 Upload Your Birth Certificate:
                  </label>
                  <div className='flex items-center w-full sm:w-auto'>
                    <input 
            ...
            <form className='flex flex-col gap-6 w-full max-w-xl'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                >
                  ...
                  <option value="Single" className='singleCol'>Single</option>
                  <option className='singleCol' value="Married">Married</option>
                </select>
              </div>
              ...
              <div className='flex flex-col gap-2'>
                <label htmlFor="debt_status" className='font-semibold text-lg tracking-wide flex'>
                  <FontAwesomeIcon icon={faCircleExclamation} className="werey2 mr-2 text-[#0ef]" /> Are you currently in any debt?
                </label>
                <select 
                  name="debt_status" 
                  id="debt_status" 
