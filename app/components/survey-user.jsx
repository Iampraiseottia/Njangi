  ...
  return (
    <main className="flex relative justify-center items-center w-full min-h-screen bg-gray-800 text-white p-4">
      ...
      <motion.section
        ...
        className=" w-full max-w-7xl bg-transparent border-2 border-blue-600  overflow-hidden rounded-lg wrapper3 my-8 "
      >
        ...
        <button className="mt-3 bg-gradient-to-r from-blue-600  via-slate-700 to-blue-600  w-[90%] text-white mb-10 py-4 px-6 font-extrabold text-xl lg:text-2xl duration-500 rounded-sm hover:rounded-[40px] hover:opacity-95 cursor-pointer flex justify-center items-center ml-[5%]">
          Complete Survey ✅
        </button>
      </motion.section>
    </main>
