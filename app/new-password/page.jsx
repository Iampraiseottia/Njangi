  ...
  return (
    <main className="flex justify-center items-center w-full min-h-screen bg-gray-800 text-white p-4">
      ...
      <motion.section
        ...
        className="sm:w-full md:w-[80%] lg:w-[40%] max-w-7xl bg-transparent border-2 border-blue-600  overflow-hidden rounded-lg wrapper4 my-8"
      >
            ...
            <div className="ease-in-out transition-all">
              ...
              <div className="mt-4 mb-1 relative">
                <input
                  ...
                  } py-3 px-4 focus:ring-1 focus:ring-blue-600  focus:outline-none duration-300 placeholder-white pr-10`}
                />
                <button
                  type="button"
