...
const New_Password = () => {
  ...
  const [fieldValidation, setFieldValidation] = useState({
    newPassword: { isValid: null, hasInteracted: false },
    confirmNewPassword: { isValid: null, hasInteracted: false },
  });
    ...
    try {
      switch (fieldName) {
        ...
        case "confirmNewPassword":
          return value === newPassword && value.length >= 8;
        default:
          return false;
      }
    } catch (error) {
  ...
  const getBorderColor = (fieldName, fieldValue) => {
    ...
    if (!field.hasInteracted) {
      return "dark:border-[#d1ce89] border-blue-500 focus:ring-blue-600 dark:focus:ring-[#d1ce89]";
    }
  ...
  const handleInputChange = (fieldName, value) => {
    ...
    if (fieldName === "password" && confirmNewPassword.length > 0) {
      const confirmNewPasswordValid = validateField(
        "confirmNewPassword",
        confirmNewPassword
      );
      setFieldValidation((prev) => ({
        ...
        confirmNewPassword: {
          ...
          hasInteracted: prev.confirmNewPassword.hasInteracted,
        },
      }));
    }
  };
          ...
          <div className="w-full lg:w-[100%] p-6 lg:p-9">
            ...
            >
              <div className="ease-in-out transition-all">
                <label
                  htmlFor="new_pass"
                  className="text-left text-[22px] font-medium tracking-wider flex items-center"
                >
                ...
                <div className="mt-4 mb-1 relative">
                  <input
                    ...
                    ${getBorderColor("newPassword", newPassword)}`}
                  />
                  <button
                    type="button"
                    onClick={toggleNewPasswordVisibility}
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-blue-600 dark:text-white dark:hover:text-white hover:text-blue-700"
                  >
                    <FontAwesomeIcon
                ...
                <div className="mt-4 mb-1 relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white-600 text-blue-600 dark:text-white dark:hover:text-white hover:text-blue-700"
                  >
                    <FontAwesomeIcon
