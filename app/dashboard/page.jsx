    ...
    <section className='w-full flex'>
      ...
      <div className='w-1/6 bg-[lightseagreen] dashboard-sidebar-border h-[100vh] sticky top-0 left-0 bottom-0 border-2 border-[lightseagreen] border-solid text-center align-middle py-20 text-white text-2xl font-semibold'>
        ...
        <div 
          ...
          className={`mb-4 flex align-middle justify-center hover:cursor-pointer ease-in-out duration-300 ${activeComponent === 'dashboardMain' ? 'text-gold' : ''}`}
        >
        ...
        <div className='relative mb-4'>
          ...
          {isOpen && (
            <ul className='mt-2 w-full rounded ease-in-out duration-300'>
              <li className={`p-2 ${activeComponent === 'about-you' ? 'text-gold' : ''}`} onClick={() => setActiveComponent('about-you')}>About You</li>
              <li className={`p-2 ${activeComponent === 'income' ? 'text-gold' : ''}`} onClick={() => setActiveComponent('income')}>Income</li>
              <li className={`p-2 ${activeComponent === 'identity' ? 'text-gold' : ''}`} onClick={() => setActiveComponent('identity')}>Identity</li>
              <li className={`p-2 ${activeComponent === 'survey' ? 'text-gold' : ''}`} onClick={() => setActiveComponent('survey')}>Survey</li>
            </ul>
          )}
        </div>
        ...
        <div 
          ...
          className={`mt-4 flex items-center justify-center hover:cursor-pointer ease-in-out duration-300 ${activeComponent === 'groups' ? 'text-gold' : ''}`}
        >
        ...
        <div 
          ...
          className={`mt-5 flex items-center justify-center hover:cursor-pointer ease-in-out duration-300 ${activeComponent === 'transactions' ? 'text-gold' : ''}`}
        >
        ...
        <div 
          ...
          className={`mt-5 mb-4 flex align-middle justify-center hover:cursor-pointer ease-in-out duration-300 ${activeComponent === 'profile' ? 'text-gold' : ''}`}
        >
        ...
        <div 
          ...
          className={`mt-5 mb-4 flex align-middle justify-center hover:cursor-pointer ease-in-out duration-300 ${activeComponent === 'settings' ? 'text-gold' : ''}`}
        >
        ...
        <div 
          ...
          className={`mt-5 mb-4 flex align-middle justify-center hover:cursor-pointer ease-in-out duration-300 ${activeComponent === 'logout' ? 'text-gold' : ''}`}
        >
