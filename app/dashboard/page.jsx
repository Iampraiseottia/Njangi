...
const DashBoard = () => {
  ...
  return (
    <section className='w-full flex'>
      ...
      <div className='w-1/6 bg-[lightseagreen] dashboard-sidebar-border h-[100vh] sticky top-0 left-0 bottom-0 border-2 border-[lightseagreen] border-solid text-center align-middle py-12 text-white text-2xl font-semibold'>
        <div className=' flex items-center justify-center align-middle'>
          <img src="/google.png" className='w-48 lg:w-48 h-44 mb-6 mr-2' alt="NJANGI Logo" /> 
